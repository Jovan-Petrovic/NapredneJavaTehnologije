...
public class Start {
    public static void main(String[] args) throws Exception {
        ...
        try{
            ...
            proizvodi.add(new Proizvod(222, "n2", BigDecimal.valueOf(2)));
            proizvodi.add(new Proizvod(332, "n3", BigDecimal.valueOf(3)));
            proizvodi.add(new Proizvod(442, "n4", BigDecimal.valueOf(4)));
...
*/
        ...
        try{
            //System.out.println(dbbr.getAllProizvod());
            //dbbr.insertProizvodResultSet(p);
            dbbr.updateProizvodResultSet(p);
            dbbr.potvrdiTransakciju();
        }catch(Exception e){
            dbbr.ponistiTransakciju();
            e.printStackTrace();
